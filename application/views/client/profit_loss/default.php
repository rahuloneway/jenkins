    ...
    <div class="container-fluid ">
        ...
        <div class="account_sum border_box_trial">
                ...
                <div class="panel-body row" >
                    <div class="col-md-12 col-sm-12 col-xs-12" >
                        ...
                        <div class="col-md-3" style="font-size:16px;">
                            <label><b><?php echo $this->lang->line("TB_PL_ACCOUNT_PROFT_LOST"); ?></b></label>
                        </div>
                        <!--<div class="col-md-3"> 
                        ...
                        <div class="col-md-1 col-sm-3 col-xs-12 text-right padding_field btn_float"> 
                           ...
                           <ul class="dropdown-menu" style="min-width:138px !important;margin-left:14px !important;border-radius:none !important;border:none; ">
                                <li>
                                    <a id="uploadDocument" class="" href="<?php echo site_url() . 'get_trialbalance_to_file_profit_xlx'; ?>">
                                        <span class="glyphicon glyphicon-download-alt"></span>Excel 
                                    </a>
                                </li>
                                <li>
                                    <a id="uploadDocument" class="get_trialbalance_to_file_profit_pdf" href="<?php echo site_url() . 'get_trialbalance_to_file_profit_pdf'; ?>">
            ...
            <div class="table-responsive" id="TBListing" >
                <?php $this->load->view('client/profit_loss/listing'); ?> 
            </div>
        </div>
    </div>
</section>
