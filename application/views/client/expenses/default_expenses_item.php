        ...
        <div class="account_sum">
            ...
            <div class="panel panel-default panel_custom">
                <div class="panel-body ">
                    <?php
                    echo form_open(site_url() . 'clients/expenses/searchItem', array('name' => 'expense-search'));
                    ?>
                    <div class="row">
                        <div class="col-md-3 col-sm-3 col-xs-12 padding_field">
                            ...
                            <div class="wid-70" >
                                <?php
                                echo exCategories("GEN", "ExpenseCategory[]", $val->Category, 'class="form-control ExpenseCategory"');
                                ?>
                            </div>
                        </div>
                        <div class="col-md-3 col-sm-3 col-xs-12 padding_field">
                        ...
                        <div class="col-md-3  col-sm-3 col-xs-12 text-right padding_field btn_float pull-right ">
                            ...
                            <a href="<?php echo base_url() . "expenses" ?>" type="button" class="btn  btn_search ">
                                <span class="glyphicon glyphicon-fast-backward"></span>Back 
                            </a>
                            <a href="#" type="button" class="btn  btn_search">
            ...
            <div class="panel panel-default panel_custom" style="height:40px;">
                <div class="panel-body row ">
                    <div class="col-md-4 col-xs-12 ePagination">
