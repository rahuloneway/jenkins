    ...
    <div class="panel panel-default panel_custom">
        <div class="panel-body row">
            ...
            <div class="col-md-4  col-sm-3 col-xs-12 padding_field">
                ...
                <div class="wid-70" >
                    <?php echo form_dropdown('Month', month(), $item['Month'], 'class="form-control required MonthDropdown" id="Month"'); ?>
                </div>
            </div>
            <div class="col-md-4  col-sm-3 col-xs-12 padding_field">
                <div class="wid-30">
                ...
                <div class="wid-70" >
                    ...
                    echo form_dropdown('Year', $years, $item['Year'], 'class="form-control YearDropdown" id="Year"');
                    ?>
                </div>
            </div>
