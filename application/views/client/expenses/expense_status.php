                    ...
                    <table class="tbl-editable" id="invoiceTable">
                        ...
                        <tbody>
                            ...
                            foreach ($item['ExpenseItems'] as $key => $val): ?>
                                <tr>
									...
									<td>
                                        <?php
											echo categoryNameTrialCat($val->Category);
                                        ?>
                                    </td>
                                    <td>
                        ...
                        <tfoot>
                            <tr>
                                ...
                                <td colspan="4" class="well text-right text_right">
                    ...
                    <table class="tbl-editable" id="invoiceTable">
                        ...
                        <tfoot>
                            <tr>
                                ...
                                <td class="well text-right text_right" style="text-align: center";>
                                    <span>
                                        <?php echo $this->lang->line('EXPENSE_TABLE_COLUMN_TOTAL_MILES'); ?>
                                    </span>
                                </td>
                                <td class="well text-right" style="width: 80px";>
                                    <span><?php echo $total_miles; ?></span>
                                </td>
                            </tr>
							
                            <tr>
                                <td colspan="5" class="well text-right text_right">
                                    <span>
...
<div class="modal-footer">
    <?php
    if (cDate($item['PaidOn']) == '' && $access != 0) {
        $href = $this->encrypt->encode('ACTION_PAID/' . $item['ID']);
        echo '<a href= "' . $href . '"class="btn btn-info btn-sm color markPaid">';
        echo 'Mark as Paid';
        echo '</a>';
    }
    ?>
    <a type="button" class="btn btn-primary btn-sm"data-dismiss="modal">
