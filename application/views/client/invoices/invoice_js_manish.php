...
<script>
    ...
    $(document).ready(function(){		
		...
		jQuery(function($){
			$("#sDueStart,#sDueEnd,#invoiceDate,#sCreatedStart,#CurrentDate,#sCreatedEnd,.sdatepicker").mask("99-99-9999");
	
		});
		
	
		jQuery('body').on('dblclick','#sDueStart,#invoiceDate,#creDate,#CurrentDate,#paidDate,#dueDate,.sdatepicker',function($){	
			alert('test');			 
			...
			//$('#invoiceDate,#CurrentDate,#creDate,#dueDate,#expensedatepicker,#paidDate,.sdatepicker').dblclick(function() {
				// jQuery(document).ready(function(){
        // jQuery(document).on('dbclick','.sdatepicker',function($){		alert('test');
            // // $("#sDueStart,#invoiceDate,#creDate,#CurrentDate,#paidDate,#dueDate,.sdatepicker").datepicker();
			 // // $( "#sDueStart,#invoiceDate,#creDate,#CurrentDate,#paidDate,#dueDate,.sdatepicker" ).datepicker("show")({
        ...
        $(document).on('click','.changeToPaid',function(e){
            ...
            var datetext = "Please choose the paid date <input type='text' name='inpaidDate'id='inpaidDate' class='sdatepicker required'/><br/><br/>";
                ...
                buttons: {
                    Yes: function() {
						...
						if (paidDate == '') 
						{
							...
							//$('#firstt').html('Please fill date first');
							alert('Please fill date first');
							//var text = datetext+'<?php echo $this->lang->line('CLIENT_INVOICE_PAID_ERROR'); ?>';
							//dialogBox(tit,text,'#inpaidDate');	
