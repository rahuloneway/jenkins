...
<?php
$this->load->view('client/header', array('page' => 'invoices', 'title' => $title));
...
<section class="grey-body">
    <div class="container-fluid ">
        <div class="account_sum">
            ...
            <ul class="nav nav-tabs">
                <li class="tab-bg active">
                    <a data-toggle="tab" href="#invoices_tab">
                        <?php echo $this->lang->line('INVOICE_PAGE_LABLE_INVOICES'); ?>
                    </a>
                </li>
                ...
                <?php } else { ?>
                    <li class="tab-bg">
                        <a data-toggle="tab" href="#vat_summary_tab">
                            <?php echo $this->lang->line('INVOICE_PAGE_LABLE_VAT_SUMARY'); ?>
                        </a>
                    </li>
                <?php } ?>
            </ul>
            ...
            <!-- h4><?php echo $this->lang->line('CLIENT_INVOICE_FORM_LABEL_LISTING'); ?></h4 -->
                    <?php echo form_open('client/invoiceSearch', array('name' => 'invoice-search', 'id' => 'invoice-search')); ?>
	...
	<div class="modal fade modal-vat-details" id="modal-vat-details" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true"data-backdrop="static">
        <div class="modal-dialog modal-mm">
            <div class="modal-content">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal" style="line-height:.5">
                        <span aria-hidden="true">&times;</span>
                        <span class="sr-only"><?php echo $this->lang->line('BUTTON_CLOSE'); ?></span>
                    </button>
                    <h4 class="modal-title1" id=""><?php echo $this->lang->line('INVOICE_VAT_CREDENTIAL'); ?></h4>
					<input type="hidden" value="" id="hmrcId" />
					<input type="hidden" value="" id="hmrcPass" />
					<input type="hidden" value="" id="hmrcquarter" />
					<input type="hidden" value="" id="hmrcquarterfrom_date" />
					<input type="hidden" value="" id="hmrcquarterto_date" />
                </div>
                <div class="modal-body2">
					<div class="row">
						<div class="col-md-12 spac_inpu_text">
							...
							<div class="col-md-4">
								<select name="Vat_capacity" id="Vat_capacity" class="form-control"> 
									<option value="Company" <?php if($Vat_capacity == 'Company'){ echo "selected";} ?>> Company </option>
									<option value="Agent" <?php if($Vat_capacity == 'Agent'){ echo "selected";} ?>> Agent </option>
									<option value="Individual" <?php if($Vat_capacity == 'Individual'){ echo "selected";}?>> Individual </option>
								</select>
							</div>
						</div> 
						<div class="col-md-12 spac_inpu_text">
							...
							<div class="col-md-4">
								<input type="text" placeholder=""class="form-control" name="Vat_userid" id="Vat_userid" 
								value="<?php echo $Vat_userid; ?>" disabled="disabled"/>
							</div>
						</div>
						<div class="col-md-12 spac_inpu_text">
							<div class="col-md-2"></div>
							...
							<div class="col-md-4">
								<input type="text" placeholder=""class="form-control" name="Vat_pass" id="Vat_pass" 
								value="<?php echo $Vat_pass; ?>" readonly="readonly"  disabled="disabled" />
							</div>
						</div> 
						<div class="col-md-12 spac_inpu_text">
							<div class="col-md-2"></div>
							...
							<div class="col-md-4">
								<input type="text" placeholder=""class="form-control" name="vat_number" id="vat_number" value="<?php echo $vat_number; ?>" readonly="readonly"  disabled="disabled" />
							</div>
						</div> 
						<div class="col-md-12 spac_inpu_text">
							<div class="col-md-5"></div>
							<div class="col-md-7">
								<input type="button" name="submitVat" class="submitVat btn btn-info btn-xs color" value="Submit"/>
								<a type="button"  data-dismiss="modal" name="cancel" class="btn btn-info btn-xs color closeDialogForm"  value="Cancel" >Cancel</a>
							</div>
						</div>     
