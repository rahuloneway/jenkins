...
?>
<h3 align="center" > <?php echo $companyName.' ( VAT Registration: '. $VATRegistrationNo .' )'; ?> </h3>
        ...
        <tbody>
            ...
            foreach ($quarterDetails as $qDetails) {
                ...
                <tr bgcolor="<?php echo $color; ?>" >
                    <td align="center" style="<?php echo $bRight . $bleft; ?>" ><?php echo vDate($qDetails->InvoiceDate); ?></td>
                    <td align="center" style="<?php echo $bRight; ?>" ><?php echo $qDetails->companyName; ?></td>
                    ...
                    <td align="center" style="<?php echo $bRight; ?>" >
                        ...
                        if ($vat_listing->Type == 'flat' || $vat_listing->Type == 'stand') {
                            if ($qDetails->InvoiceTotal != 0 ) {								
                                if (strtotime(cDate($qDetails->InvoiceDate)) < strtotime(cDate($user['EndDate']))) {
    ...
    <?php if ($quarterDetails && $total_inv_amount != 0) { ?>
        <tfoot>
            <tr bgcolor="#f1f1f1" color="#000" >
                ...
                <td align="center" style="<?php echo $bTopBottom . $bRight; ?>" ><strong><?php echo $this->lang->line('VAT_TOTAL_VALUE'); ?>:</strong></td>
...
<?php if ($EXPitems) { ?>
    ...
    <table cellpadding="5"  >
        <thead>
            <tr bgcolor="#458ACE" color="#fff"  >
                <th align="center" style="<?php echo $bTopBottom . $bRightLight . $bleft; ?>" >
                    <?php echo $this->lang->line('VAT_SUMMARY_POPUP_EXP_NO_COL_LABEL'); ?>
                </th>
                <th align="center" style="<?php echo $bHeadTopBottomRight; ?>" >
                    <?php echo $this->lang->line('VAT_SUMMARY_POPUP_CDATE_COL_LABEL'); ?>
                </th>
                <th align="center" style="<?php echo $bHeadTopBottomRight; ?>" >
                    <?php echo $this->lang->line('VAT_SUMMARY_POPUP_PDATE_COL_LABEL'); ?>
                </th>
                <th align="center" style="<?php echo $bHeadTopBottomRight; ?>" >
                    <?php echo $this->lang->line('VAT_TOTAL_VALUE'); ?>
                </th>
                <th align="center" style="<?php echo $bTopBottom . $bRight; ?>"  >
                    <?php echo $this->lang->line('VAT_SUMMARY_POPUP_EXP_VAT_COL_LABEL'); ?>
                </th>
            </tr>
        </thead>
        <tbody>
        ...
        <thead>
            <tr bgcolor="#f1f1f1" color="#000" >
                <td align="right" width="80%" style="<?php echo $bTopBottom . $bleft . $bRight; ?>" >
                    <strong><?php echo $this->lang->line('VAT_TOTAL_DUE'); ?>: &nbsp; &nbsp;</strong>
                </td>
