...
<table cellpadding="2">
    <thead>
        <tr>
            ...
            <td align="right" colspan="3">
                ...
                ?>
                <?php echo $this->lang->line('PURCHASE_PDF_TEXT_ONE'); ?><?php echo $item['InvoiceNumber']; ?>
                <br/><?php echo $this->lang->line('PURCHASE_PDF_TEXT_TWO'); ?><?php echo cDate($item['InvoiceDate']); ?>
                <br/><?php echo $this->lang->line('PURCHASE_PDF_TEXT_THREE'); ?><?php echo cDate($item['DueDate']); ?>
            </td>
        </tr>
        <tr style="border-top:1px solid #000;height:300px;">
            <td align="center"><br/><br/><br/><?php echo $this->lang->line('PURCHASE_PDF_TEXT_FOUR'); ?></td>
            <td colspan="6">
                <br/><br/><br/>
                    ...
                    <thead>
                        <tr bgcolor="#458ACE" color="#fff">
                            <th align="center" style="height:40px;">
                                <?php echo $this->lang->line('PURCHASE_PDF_TEXT_FIVE'); ?>
                            </th>
                            <th colspan="2" align="center">
                                <?php echo $this->lang->line('PURCHASE_PAGE_LABLE_DESCRIPTION'); ?>
                            </th>
                            <th align="center">
                                <?php echo $this->lang->line('CLIENT_PURCHASE_LABLE_QUANTITY'); ?>
                            </th>
                            <th align="center">
                                <?php echo $this->lang->line('CLIENT_PURCHASE_LABLE_UNIT_PRICE'); ?>
                            </th>

                            <th align="center">
                                <?php echo $this->lang->line('PURCHASE_PAGE_LABLE_AMOUNT_GBP'); ?>
                            </th>
                            <!--th align="center">
                                    Amount GBP
                            </th -->
                    ...
                    <tfoot>
                        <tr>
                            <td align="right" colspan="5">
                                <p><?php echo $this->lang->line('PURCHASE_PAGE_LABLE_SUBTOTAL'); ?></p>
                            </td>
                            <td align="right">
                        ...
                        <?php } else { ?>
                            <tr style="">
                                <td align="right" colspan="5" >
                                    <p><?php echo $this->lang->line('PURCHASE_PAGE_LABLE_VAT'); ?></p>
                                </td>
                                <td align="right">
                        ...
                        <tr bgcolor="#458ACE" color="#fff">
                            <td align="right" colspan="5">
                                <p><?php echo $this->lang->line('PURCHASE_PAGE_LABLE_TOTAL'); ?></p>
                            </td>
                            <td align="right">
    ...
    <tfoot>
        <tr>
            ...
            <?php } else { ?>
                <td align="right">
                  <span width="10px"></span><?php echo $this->lang->line('PURCHASE_PDF_TEXT_SIX'); ?>
            </td>
        ...
        <?php if (count($item['Bank_Details']) != 0): ?>
            <tr>
                <td align="right">
                    <?php echo $this->lang->line('PURCHASE_PDF_TEXT_SEVEN'); ?>
                </td>
                <td colspan="6" align="left">
            ...
            <tr>
                <td align="right">
                    <?php echo $this->lang->line('PURCHASE_PDF_TEXT_EIGHT'); ?>
                </td>
                <td colspan="6" align="left">
            ...
            <tr>
                <td align="right">
                    <?php echo $this->lang->line('PURCHASE_PDF_TEXT_NINE'); ?>
                </td>
                <td colspan="6" align="left">
        ...
        <tr >
            <td colspan="7" align="center" valign="middle" height="100">
                <br/><br/><br/>
                <p><?php echo $this->lang->line('PURCHASE_PDF_TEXT_TEN'); ?><?php echo $item['RegistrationNumber']; ?></p>
                <p>
                    <?php echo $this->lang->line('PURCHASE_PDF_TEXT_ELEVEN'); ?><?php echo $Country; ?>
                </p>
            </td>
        </tr>
    </tfoot>
