...
<script>
    ...
    $(document).ready(function(){		
		...
		jQuery(function($){
	$("#sDueStart,#sDueEnd,#sCreatedStart,#CurrentDate,#sCreatedEnd,#invoiceDate").mask("99-99-9999");
	
});
		
		
		jQuery('body').on('dblclick','#invoiceDate,#CurrentDate,paidDate,#creDate,#dueDate,#expensedatepicker,.sdatepicker',function($){	
			//alert('test');			 
...
$(document).on('focus','#invoiceDate,#CurrentDate,paidDate,#creDate,#dueDate,#expensedatepicker,.sdatepicker').dblclick(function(){
            $("#invoiceDate,#creDate,#CurrentDate,paidDate,#dueDate,.sdatepicker").datepicker();
			 $("#invoiceDate,#creDate,#CurrentDate,paidDate,#dueDate,.sdatepicker").datepicker("show")({
                dateFormat: 'dd-mm-yy',
                changeMonth: true,
                changeYear: true,
                yearRange: "-50:+1",
