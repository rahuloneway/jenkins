    ...
    <div class="container-fluid ">
        <div class="account_sum border_box_trial">
			...
			<div class="listing-container">    
				...
				<div id="bank_tab" class="tab-pane fade in <?php if($_POST['search_bs'] == 'yes'){ echo "active";} ?>">
					<div class="panel panel-default panel_custom">
						<div class="panel-body row">
						<?php echo form_open('email', array('name' => 'email-search', 'id' => 'email-search')); ?>						<input type="hidden" name="search_bs" value="yes" >
							<div class="top_btm_spc">
								<div class="col-md-4 col-sm-4 col-xs-12  padding_field">
									<div class="wid-40">
										...
										?>
									<div class="wid-60">
										<input type="text" placeholder="" name="StartDate" class="form-control sDatepicker" value="<?php echo $Start_date; ?>" id="">
									</div>							
								</div>
								<!-- <div class="col-md-3 col-sm-3 col-xs-12 text-right padding_field btn_float pull-right"> -->
								<div class="col-md-3 col-sm-3 col-xs-12 text-right padding_field btn_float"> 
									<button class="btn  btn_search btn-search" type="submit">
										<span class="glyphicon glyphicon-search"></span>Search
									</button> 
									<a class="btn  btn_search reset" type="button" href="<?php echo site_url();?>email">
								...
								<!--<div class="col-md-3 col-sm-3 col-xs-12  padding_field">
									...
									<div class="wid-60">
										<?php //echo date('d-m-Y',strtotime('last day of last month')); ?>
										<?php 
											if($this->session->userdata('MailBankStatmentTo')){
												$Last_date = $this->session->userdata('MailBankStatmentTo'); 
											}else{
												$Last_date ="";
											}
										?>
										<input type="text" placeholder="" name="EndtDate" class="form-control eDatepicker" value="<?php echo $Last_date; ?>" id="">
									</div>							
								</div>-->
								<!-- <div class="col-md-3 col-sm-3 col-xs-12  padding_field">
									<div class="wid-40">
									...
									<div class="wid-60">
										<input type="text" placeholder="End Date" name="EndtDate" class="form-control yDatepicker" value="" id="">
									</div>							
								</div> -->								
							</div>
						<?php
					...
					<div class="listing-container">    
						...
						?>
						<input type="hidden" name="bs_mail" value="bs_mail" >
						<div class="table-responsive">					
							<!--------------- Bank Statment Due --------------->							
							<?php
							$sno = '';
									...
									foreach ($bankstatment_items as $key => $val) {
										...
										if($this->session->userdata('MailBankStatmentFrom') != ''){											
											if( strtotime(cDate($val->last_uplode_date)) < strtotime($this->session->userdata('MailBankStatmentFrom')) ){												
												echo '<tr>';
												echo '<td>';
												echo ' <input type="checkbox" class="email-statement-check checkbox2" name="cb[]" value="' . $val->ID . '"/></td>';
												echo '</td>';
												echo '<td>';
												echo $sno;
												echo '</td>';
												...
												echo '</td>';																				
												echo '<td>';
												echo cDate($val->last_uplode_date);
												echo '</td>';												
											...
											if( strtotime(cDate($val->last_uplode_date)) <  strtotime(date("d-m-Y")) ){
												...
												echo '<tr>';
												echo '<td>';
												echo ' <input type="checkbox" class="email-statement-check checkbox2" name="cb[]" value="' . $val->ClientID.'-'.$val->CID.'"/></td>';
												echo '</td>';
												echo '<td>';
												echo $sno;
												echo '</td>';
