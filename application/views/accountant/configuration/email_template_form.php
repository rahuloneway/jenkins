<section>
    <div class="row data_opn">
        <?php
        echo form_open(site_url() . 'accountant/configuration/saveTemplate', array('name' => 'fromEmailtemplate', 'id' => 'fromEmailtemplate'));
        ?>
        <div class="col-md-12">
            <div class="col-md-9">  
                <div class="col-md-12">
            ...
            <div class="modal-footer">
                ...
                <div class="pull-right">
                    <button type="button" class="btn btn-primary addemailTemplate btn-sm spacer" id="addemailTemplate">
