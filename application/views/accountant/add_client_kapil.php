            ...
            <div class="tab-content client_custom">
                ...
                <div id="client_details" class="tab-pane active client_detail">
				   ...
				   <div class="col-md-5 spc_below">
                    ...
                    <div class="col-md-5 spc_below">
                        ...
                        <div class="wid-70">
                            <input type="text" id="DOB" name="DOB" class="form-control datepicker" placeholder="" value="<?php if(!empty($item)){ echo cDate($item['USER']->Params['DOB']); } ?>" />
                        </div>
                    </div>
                    <div class="col-md-5 col-md-offset-2 spc_below">
                        <div class="wid-30">
                    ...
                    <div class="col-md-5 spc_below">
                        ...
                        <div class="wid-70">
                            <input type="text" name="utr" id="utr" class="form-control utrnumber" placeholder="" maxlength="10" value="<?php echo $item['USER']->Params['UTR']; ?>" />
                        </div>
                    </div>
                    <div class="col-md-5 col-md-offset-2 spc_below">
                        <div class="wid-30">
                    ...
                    <div class="col-md-5 col-md-offset-2 spc_below">
                        ...
                        <div class="wid-70">
                            <input type="text" name="phoneNo" id="phoneNo" class="form-control phonenumber required" placeholder="" maxlength="11" value="<?php echo $item['USER']->ContactNo; ?>" />
                        </div>
                    </div>
                    <div class="clr"></div>
                    <div class="col-md-5  spc_below">
						...
						<div class="sh-contnt-company">
							...
							<div class="border_box">
								<div class="col-md-5 spc_below">
									...
									<div class="wid-70">
										<input type="text" name="CompanyName" id="CompanyName" class="form-control required"    placeholder=""/>
									</div>
								</div>
								<div class="col-md-5 col-md-offset-2 spc_below">
									<div class="wid-30">
									...
									<div class="wid-70">
										<input type="text"  name="TradingName" id="TradingName" class="form-control"    placeholder=""/>
									</div>
								</div>
								<div class="clr"></div>
								<div class="col-md-5 spc_below">
									...
									<div class="wid-70">
										<input type="text" name="ExpectedAmount" id="ExpectedAmount" class="form-control validNumber"    placeholder=""/>
									</div>
								</div>
								<div class="col-md-5 col-md-offset-2 spc_below">
									<div class="wid-30">
								...
								<div class="col-md-5 spc_below">
									...
									<div class="wid-70">
										<input type="text" name="PayeReference" id="PayeReference" class="form-control PayeReference"    placeholder=""/>
									</div>
								</div>
								<div class="col-md-5 col-md-offset-2 spc_below">
									<div class="wid-30">
									...
									<div class="wid-70">
										<input type="text" name="PayeAccountReference" id="PayeAccountReference" class="form-control payeref"placeholder=""/ maxlength="13">
									</div>
								</div>
								<div class="clr"></div>
								<div class="col-md-5  spc_below">
									...
									<div class="wid-70">
										<input type="text" name="CompanyRegisteredNo" id="CompanyRegisteredNo" class="form-control required" placeholder=" " maxlength="8"/>
									</div>
								</div>
								<div class="col-md-5 col-md-offset-2 spc_below">
									<div class="wid-30">
									...
									<div class="wid-70">
										<input type="text" name="TaxReference" id="TaxReference" class="form-control"    placeholder=" "/>
									</div>
								</div>
								<div class="clr"></div>
								<div class="col-md-5  spc_below">
									...
									<div class="wid-70">
										<input type="text" name="IncorporationDate" id="IncorporationDate" class="form-control datepicker"placeholder=" "/>
									</div>
								</div>
								<div class="col-md-5 col-md-offset-2 spc_below">
									<div class="wid-30">
									...
									<div class="wid-70">
										<input type="text" name="ReturnDate" id="ReturnDate" class="form-control datepicker" placeholder=" "/>
									</div>
								</div>
								<div class="clr"></div>
								<div class="col-md-5  spc_below">
									...
									<div class="wid-70">
										<input type="text" name="YearEndDate" id="YearEndDate" class="form-control datepicker required"placeholder=" "/>
									</div>
								</div>
								<div class="col-md-5 col-md-offset-2 spc_below">
									<div class="wid-30">
									...
									<div class="wid-70">
										<input type="text" name="FaxNo" id="FaxNo" class="form-control "    placeholder=" "/>
									</div>
								</div>
								<div class="clr"></div>
								<div class="col-md-5  spc_below">
									...
									<div class="wid-70">
										<input type="text" name="CompanyEmail" id="CompanyEmail" class="form-control email"    placeholder=" "/>
									</div>
								</div>
								<div class="col-md-5 col-md-offset-2 spc_below">
									<div class="wid-30">
									...
									<div class="wid-70">
										<input type="text" name="CompanyWebsite" id="CompanyWebsite" class="form-control "    placeholder=" "/>
									</div>
								</div>
								<div class="clr"></div>
								<div class="col-md-5  spc_below">
									...
									<div class="wid-70">
										<textarea class="form-control" rows="0" name="BussinessDescription" id="BussinessDescription"></textarea>
									</div>
								</div>
								<div class="col-md-5  col-md-offset-2 spc_below">
									<div class="wid-30">
								...
								<div id="reg_address" >
									<div class="col-md-5 spc_below">
										...
										<div class="wid-70">
											<input type="text" class="form-control"  name="CompanyAddOne" id="CompanyAddOne"  placeholder=""/>
										</div>
									</div>
									<div class="col-md-5 col-md-offset-2 spc_below">
										<div class="wid-30">
										...
										<div class="wid-70">
											<input type="text" class="form-control"  name="CompanyAddTwo" id="CompanyAddTwo"  placeholder=""/>
										</div>
									</div>
									<div class="col-md-5 spc_below">
										<div class="wid-30">
										...
										<div class="wid-70">
											<input type="text" class="form-control" name="CompanyAddThree" id="CompanyAddThree"   placeholder=" "/>
										</div>
									</div>
									<div class="col-md-5 col-md-offset-2 spc_below">
										<div class="wid-30">
										...
										<div class="wid-70">
											<input type="text" class="form-control postalcode"  name="CompanyPostalCode" id="CompanyPostalCode"  placeholder=" "/>
										</div>
									</div>
									<div class="col-md-5 spc_below">
										<div class="wid-30">
									...
									<div class="col-md-5 col-md-offset-2 spc_below">
										...
										<div class="wid-70">
											<input type="text" class="form-control phonenumber"  name="CompanyPhoneNo" id="CompanyPhoneNo"  placeholder=" "maxlength="11"/>
										</div>
									</div>
								</div>
								<div class="clr"></div>
								...
								<div id="cont_address" >
									<div class="col-md-5 spc_below">
										...
										<div class="wid-70">
											<input type="text" class="form-control"  name="CCAddressOne" id="CCAddressOne"  placeholder=""/>
										</div>
									</div>
									<div class="col-md-5 col-md-offset-2 spc_below">
										<div class="wid-30">
										...
										<div class="wid-70">
											<input type="text" class="form-control" name="CCAddressTwo" id="CCAddressTwo"   placeholder=""/>
										</div>
									</div>
									<div class="col-md-5 spc_below">
										<div class="wid-30">
										...
										<div class="wid-70">
											<input type="text" class="form-control" name="CCAddressThree" id="CCAddressThree"   placeholder=" "/>
										</div>
									</div>
									<div class="col-md-5 col-md-offset-2 spc_below">
										<div class="wid-30">
										...
										<div class="wid-70">
											<input type="text" class="form-control postalcode"  name="CCpostalcode" id="CCpostalcode"  placeholder=" "/>
										</div>
									</div>
									<div class="col-md-5 spc_below">
										<div class="wid-30">
									...
									<div class="col-md-5 col-md-offset-2 spc_below">
										...
										<div class="wid-70">
											<input type="text" class="form-control phonenumber" name="CCPhoneNo" id="CCPhoneNo" placeholder=" "maxlength="11"/>
										</div>
									</div>
								</div>
                ...
                <div id="vat_details" class="tab-pane client_detail">
                    ...
                    <div class="col-md-4 spc_below isRegisteredVAT">
                        ...
                        <div class="wid-70">
                            <input type="text" class="form-control required" name="VATRegisteredNo" id="VATRegisteredNo" placeholder="" maxlength="9"/>
                        </div>
                    </div>
                        ...
                        <div class="sh-cont-r vat-content1" >
                            <div class="sh-contnt-r">
								...
								<div class="col-md-3 spc_below">
									...
									<div class="wid-60">
										<input type="text"name="VATEffectiveDate" id="VATEffectiveDate"class="form-control datepicker1 required"placeholder="End date"/>
									</div>
								</div>
								<div class="col-md-3 spc_below">
									<div class="wid-40">
									...
									<div class="wid-60">
										<input type="text"name="VATEndDate" id="VATEndDate"class="form-control datepicker required"placeholder="End date"/>
									</div>
								</div>
                                ...
                                <div class="col-md-3 spc_below">
                                    ...
                                    <div class="wid-60">
                                        <input type="text" name="VATRatePercentAfterYear" id="VATRatePercentAfterYear"class="form-control" placeholder=""maxlength="5" readonly />
                                    </div>
                                </div>
                                <div class="clr"></div>
                                <br/>
                    ...
                    <div  class="standard-vat hide" >
                        ...
                        <div class="col-md-4 spc_below">
                            ...
                            <div class="wid-70">
                                <input type="text" name="VATStanderedRate" id="VATStanderedRate" class="form-control validateNumber required"placeholder="" maxlength="5"/>
                            </div>
                        </div>
                    </div>
                    <div class="clr"></div>
                ...
                <div id="sh_details" class="tab-pane client_detail">
                    <div class="col-md-5 spc_below">
                        ...
                        <div class="wid-70">
                            <input type="text" class="form-control checkField" class="TotalShares" id="TotalShares" placeholder="" name="TotalShares"/>
                        </div>
                    </div>
                    <div class="clr" ></div>
                    <div id="dir1" class="sh-contnt">
                        ...
                        <div class="border_box spc_below">
                            ...
                            <div class="col-md-5 spc_below col-md-offset-2">
                                ...
                                <div class="wid-70 ">
                                    <input type="text" name="DirectorShares" id="DirectorShares" class="form-control checkField calShares" placeholder=""/>
                                </div>
                            </div>
                            <div class="clr"></div>
                            <div class="col-md-5 spc_below">
                                ...
                                <div class="wid-70">
                                    <input type="text" name="DFirstName" id="DFirstName" readonly class="form-control"    placeholder=""/>
                                </div>
                            </div>
                            <div class="col-md-5 col-md-offset-2 spc_below">
                                <div class="wid-30">
                                ...
                                <div class="wid-70">
                                    <input type="text" name="DLastName" id="DLastName" readonly class="form-control"    placeholder=""/>
                                </div>
                            </div>
                            <div class="col-md-5 spc_below">
                                <div class="wid-30">
                                ...
                                <div class="wid-70">
                                    <input type="text" name="Ddob" id="Ddob"class="form-control datepicker"placeholder=""/>
                                </div>
                            </div>
                            <div class="col-md-5 col-md-offset-2 spc_below">
                                <div class="wid-30">
                                ...
                                <div class="wid-70">
                                    <input type="text" name="DNINumber" id="DNINumber" readonly class="form-control niNumber"placeholder=""/>
                                </div>
                            </div>
                            <div class="clr"></div>
                            <div class="col-md-5 spc_below">
                                ...
                                <div class="wid-70">
                                    <input type="text" name="DUTR" id="DUTR" readonly class="form-control utrnumber" placeholder=""maxlength="10"/>
                                </div>
                            </div>
                            <div class="col-md-5 col-md-offset-2 spc_below">
                                <div class="wid-30">
                                ...
                                <div class="wid-70">
                                    <input type="text" name="DAddressOne" id="DAddressOne" readonly class="form-control"    placeholder=""/>
                                </div>
                            </div>
                            <div class="col-md-5  spc_below">
                                <div class="wid-30">
                                ...
                                <div class="wid-70">
                                    <input type="text" name="DAddressTwo" id="DAddressTwo" readonly class="form-control"    placeholder=""/>
                                </div>
                            </div>
                            <div class="col-md-5 col-md-offset-2 spc_below">
                                <div class="wid-30">
                                ...
                                <div class="wid-70">
                                    <input type="text" name="DAddressThree" id="DAddressThree" readonly class="form-control"    placeholder=" "/>
                                </div>
                            </div>
                            <div class="col-md-5  spc_below">
                                <div class="wid-30">
                                ...
                                <div class="wid-70">
                                    <input type="text" name="DPostalCode" id="DPostalCode" readonly class="form-control postalcode"placeholder=" "/>
                                </div>
                            </div>
                            <div class="col-md-5 col-md-offset-2 spc_below">
                                <div class="wid-30">
                                ...
                                <div class="wid-70">
                                    <input type="text" name="DPhoneNo" id="DPhoneNo" readonly class="form-control phonenumber"placeholder="" maxlength="11"/>
                                </div>
                            </div>
                            <div class="col-md-5  spc_below">
                                <div class="wid-30">
                                ...
                                <div class="wid-70">
                                    <input type="text" name="DEmail" id="DEmail" readonly class="form-control"    placeholder=""/>
                                </div>
                            </div>
                            <div class="col-md-5 col-md-offset-2 spc_below">
                                <div class="wid-30">
                        ...
                        <div class="sh-contnt">
                            ...
                            <div class="border_box">
                                ...
                                <div class="col-md-5 col-md-offset-2 spc_below">
                                    ...
                                    <div class="wid-70">
                                        <input type="text" name="ShareHolderShares[]" class="form-control checkField calShares"placeholder="" readonly="readonly" />
                                    </div>
                                </div>
                                <div class="clr"></div>
                                <div class="col-md-5 spc_below">
                                    ...
                                    <div class="wid-70">
                                        <input type="text" name="SFirstName[]" disabled class="form-control"    placeholder=""/>
                                    </div>
                                </div>
                                <div class="col-md-5 col-md-offset-2 spc_below">
                                    <div class="wid-30">
                                    ...
                                    <div class="wid-70">
                                        <input type="text" name="SLastName[]" disabled class="form-control"    placeholder=""/>
                                    </div>
                                </div>
                                <div class="col-md-5 spc_below">
                                    <div class="wid-30">
                                    ...
                                    <div class="wid-70">
                                        <input type="text" name="SDOB[]"disabled class="form-control datepicker"placeholder=""/>
                                    </div>
                                </div>
                                <div class="col-md-5 col-md-offset-2 spc_below">
                                    <div class="wid-30">
                                    ...
                                    <div class="wid-70">
                                        <input type="text" name="SNINumber[]"disabled class="form-control niNumber" placeholder=""/>
                                    </div>
                                </div>
                                <div class="clr"></div>
                                <div class="col-md-5 spc_below">
                                    ...
                                    <div class="wid-70">
                                        <input type="text" name="SUTR[]" disabled class="form-control utrnumber" placeholder=""maxlength="10"/>
                                    </div>
                                </div>
                                <div class="col-md-5 col-md-offset-2 spc_below">
                                    <div class="wid-30">
                                    ...
                                    <div class="wid-70">
                                        <input type="text" name="SAddressOne[]" disabled class="form-control"    placeholder=""/>
                                    </div>
                                </div>
                                <div class="clr"></div>
                                <div class="col-md-5  spc_below">
                                    ...
                                    <div class="wid-70">
                                        <input type="text" name="SAddressTwo[]" disabled class="form-control"    placeholder=""/>
                                    </div>
                                </div>
                                <div class="col-md-5 col-md-offset-2 spc_below">
                                    <div class="wid-30">
                                    ...
                                    <div class="wid-70">
                                        <input type="text" name="SAddressThree[]" disabled class="form-control"    placeholder=" "/>
                                    </div>
                                </div>
                                <div class="col-md-5  spc_below">
                                    <div class="wid-30">
                                    ...
                                    <div class="wid-70">
                                        <input type="text" name="SPostalCode[]" disabled class="form-control postalcode"    placeholder=" "/>
                                    </div>
                                </div>
                                <div class="col-md-5 col-md-offset-2 spc_below">
                                    <div class="wid-30">
                                    ...
                                    <div class="wid-70">
                                        <input type="text" name="SPhoneNumber[]" disabled class="form-control phonenumber"placeholder=""maxlength="11"/>
                                    </div>
                                </div>
                                <div class="col-md-5  spc_below">
                                    <div class="wid-30">
                                    ...
                                    <div class="wid-70">
                                        <input type="text" name="SEmail[]"disabled class="form-control email"    placeholder=""/>
                                    </div>
                                </div>
                                <div class="col-md-5 col-md-offset-2 spc_below">
                                    <div class="wid-30">
					...
					<div class="bank-contnt">
						...
						<div class="border_box">
							...
							<div class="col-md-5 col-md-offset-2 spc_below">
								...
								<div class="wid-70">
									<input type="text" class="form-control" name="ShortCode[]" id="ShortCode" placeholder="" maxlength="6"/>
								</div>
							</div>
							<div class="col-md-5 spc_below">
								<div class="wid-30">
								...
								<div class="wid-70">
									<input type="text" class="form-control"  name="AccountNumber[]" id="AccountNumber" placeholder="" maxlength="8"/>
								</div>
							</div>
							<div class="clr"></div>
						</div>	
                ...
                <div id="revew_details" class="tab-pane client_detail">
                    ...
                    <div class="col-md-3 spc_below">
                        ...
                        <div class="wid-30">
                            <input type="text" class="form-control datepicker" name="CompanySIDate" id="sdi"placeholder=""/>
                        </div>
                    </div>
                    <div class="clr"></div>
                    <br/><br/><br/>
