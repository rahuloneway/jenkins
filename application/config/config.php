...
|*/
//$config['base_url'] = '';
$config['base_url'] = "http://".$_SERVER['HTTP_HOST']."/flexi/";
//$config['base_url'] = 'http://www.cashmann.co.uk/flexi/uat';
$config['hmrcMode']     = 'vsips';
/*
|--------------------------------------------------------------------------
| Index File
|--------------------------------------------------------------------------
...
|
*/
$config['encryption_key'] = 'BrR6Bfu4BeoFyINWWBGDtoG2cnR0CcV2';
...
$config['sess_save_path'] = BASEPATH . 'uat/cache/';
