...
*/
$config['auth_override_class_method_http']['Clientapi']['login']['get'] = 'none';
...
|
*/
$config['rest_valid_logins'] = ['api' => '123'];
...
|
*/
$config['rest_keys_table'] = 'cashman_api_keys';
...
|
*/
$config['rest_logs_table'] = 'cashman_api_logs';
...
/*
|--------------------------------------------------------------------------
| REST API response pagelimit
|--------------------------------------------------------------------------
|
| The pagelimit for response in get request at invoices_get, expense_get, dividend_get functions
|
*/
$config['rest_page_limit'] = 5;